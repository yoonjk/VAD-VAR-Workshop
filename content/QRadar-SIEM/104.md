...
3.  To load default search filters, double-click the **Log Activity** tab.
	...
	> 
	> If you need to return to the classic UI, go to the URL: https://172.16.60.10.
...
5.  Click **Single Log Source**.
    ...
    > Stop and browser through the long list of available log sources. This shows you all the log sources QRadar can integrate with out of the box.
...
13. In the **Log Source Identifier** field, type \<provided QRadar instance IP\>..
...
To view applications that provide log sources for QRadar visit the X-Force App Exchange at: https://exchange.xforce.ibmcloud.com/hub?br=QRadar&con=CO31&ippc=64&ippr=64.
