...
### \[OPTIONAL\] Request access to the live demo
...
From the CentOS desktop, open the **Applications \> Favorites \>
Firefox**.
...
1. In the QRadar Console, go to **Offenses \> All offenses**.
...
1. From the Jump Server, go to **Applications \> Favorites \>
    Terminal**.

    ![](./images/101/image16.png)

1. Connect to the QRadar SSH console.
