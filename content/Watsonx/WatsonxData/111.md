# 111: Apache Spark with watsonx.data
...
provisioned environment. For this lab’s exercises, Apache Spark is running separately within the 
...
- **Jupyter Notebook Server** - `http://region.techzone-
services.com:00000/notebooks/Table_of_Contents.ipynb` where `00000` is the port 
