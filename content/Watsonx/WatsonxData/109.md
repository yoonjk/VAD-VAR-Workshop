...
> **Note:** If you have an IBM Cloud account, you can create your own bucket and use it in this lab. You can use the following bucket but make sure, you prefix your schema with your initials.
