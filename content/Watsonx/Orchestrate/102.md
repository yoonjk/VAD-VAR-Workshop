...
1. Show the **Data source** page within the Process mining workspace, which you opened during demo preparation.
...
2. Click the decision gateway labeled **GW-XOR-19** (after **Liquidate Account**).
...
5. Click the **BO Service Closure** activity (1) and then the **Show activity statistics** icon (2).
...
6. Close the **Activity statistics** screen by clicking the **X** on the top right.

![](./images/102/017.png)

7. Click the **Launch task mining process** icon.
...
8. In the **View options** panel, under **Model view**, set the **View mode** to **Duration** (1). Click the **Variants** icon (2).
...
10. In the **Time Consumed by Application** panel at the bottom, hover within any of the activities to see the total time spent using the application.
...
11. Click the **Analytics** icon (1) and then **Processes** (2).
...
14. Click the **BPMN** tab (1) and then **Create simulation** (2).

![](./images/102/025.png)

15. Provide a **Simulation title** (such as **‘Account Closure’**) (1), and click **Create simulation** (2).
...
16. Scroll down to show different activities.
...
17. Scroll to the **BO Service Closure** activity.
...
18. Select the **Robotic quote** tab and change the percentage of automation to **100%**.
