...
4.  Seleccione el caso de uso de IA que creó en **el laboratorio 102** (por ejemplo, `<your initials or unique string> - Claim summarization`) y haga clic en la pestaña Ciclo de **vida** para ver el gráfico del ciclo de vida de este caso de uso del modelo, que reflejará el mismo progreso en la **AI Factsheet**. Observe que ahora hay una entrada para el modelo en la sección **Validar** de la vista del ciclo de vida del modelo, con un distintivo que muestra que hay una evaluación pendiente.
