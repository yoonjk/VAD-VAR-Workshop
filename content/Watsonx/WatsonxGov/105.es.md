...
*   Para saber cómo implantar un modelo de [IA genera](#deploy-a-generative-ai-model) **tiva**, continúe en [Implantar un modelo de IA **generativa**](#deploy-a-generative-ai-model)
*   Para saber cómo implantar un modelo de [IA **predictiva**](#deploy-a-predictive-ai-model), continúe en [Implantar un modelo de IA **predictiva**](#deploy-a-predictive-ai-model)

## Implantar un modelo de IA **generativa**
...
*   **Nombre:** Dé a su espacio de despliegue un nombre que incluya alguna información identificativa, el propósito para el que se utilizará e incluya "testing" para denotar que se trata de un espacio para pruebas (ej. `<your initials or unique string> - Claim summary testing`).
...
## Implantar un modelo de IA **predictiva**
