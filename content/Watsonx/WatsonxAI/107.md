...
## Run the VectorDB + web scraper + watsonx.ai (optional)
...
- **Notebook URL:** `https://raw.githubusercontent.com/ibm-build-lab/VAD-VAR-Workshop/main/content/Watsonx/WatsonxAI/files/107/use_case_rag_web.ipynb`
