...
1.  Acceda a la consola del Laboratorio de avisos. Puede experimentar con diferentes modelos, probar sus avisos, ajustar los parámetros del modelo y guardar sus sesiones de avisos. Este es el objetivo de este laboratorio.
...
1.  Posibilidad de alternar entre editores de avisos **Structured** o de avisos **Freeform**.

    a. El aviso **Structured** es el predeterminado y proporciona directrices para la creación de avisos.

    b. Los avisos de **Freeform** muestran un área de texto para interactuar con el modelo de cimentación. Probablemente lo prefieran los usuarios más experimentados.
...
| mpt-7b-instrucción2 | Sólo decodificador        | 7b         | IBM         | Generación, extracción, resumen y clasificación                                                                          |
...
5.  Mire a la izquierda del botón **Generar** y verá un texto similar al siguiente:
    ...
    > NOTA: La moneda de un LLM son los tokens. **Los tokens no se corresponden 1 a 1 con las palabras**. Algunas palabras son fichas múltiples, las contracciones y los signos de puntuación se convierten en fichas. Aproximadamente, 750 palabras equivalen a 1.000 fichas.
    <br /><br />
    Para este modelo, el máximo de fichas permitido para una transacción es de 4096. Esto varía en función del modelo.
    <br /><br />
    Dependiendo de la instancia de watsonx que se utilice, existe un límite mensual de tokens disponibles.
...
10. Repita los pasos 6-9, esta vez seleccionando el modelo **mpt-7b-instruct-2**. Debería ver la siguiente salida generada:
...
1.  [Abra una nueva sesión de Prompt Lab](/watsonx/watsonxai/000#creating-a-new-prompt-lab-session) para asegurarse de que cualquier experiementation anterior en la sesión actual no afecta a los resultados del laboratorio.
...
*   Incluso en el caso de los avisos de disparo cero, la entrada de avisos puede modificarse para obtener una mejor respuesta de los modelos de cimentación.
