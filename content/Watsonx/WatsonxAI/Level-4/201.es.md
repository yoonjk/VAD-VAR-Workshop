...
13. Pruebe el mismo prompt con los modelos *granite* y *mpt-7b-instruct- 2*. Borre el texto generado y pruebe de nuevo.
...
18. En el **Prompt Lab**, haga clic en el icono *Historia*.
...
1.  Vaya al **Prompt Lab** y abra uno de los prompts que haya creado previamente o uno de los prompts de muestra.

2.  Genere una respuesta utilizando este prompt:
...
4.  En [watsonx.ai](https://dataplatform.cloud.ibm.com/wx/home?context=wx) haz clic en el mosaico **Work with data and models in Python or R notebooks**.
