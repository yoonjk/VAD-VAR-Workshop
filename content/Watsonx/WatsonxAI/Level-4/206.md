...
You can use the same procedure from [Part 1 of the lab](/watsonx/watsonxai/101) to setup an environment to work with the labs here.
...
You can use IBM TechZone to perform the exercises in this lab. The detailed setup instructions are available in [this document](/watsonx/watsonxai/100)
...
![](../images/206/Aspose.Words.84f85360-1bb4-4987-990e-fd6c65ab6365.003.png)
...
Where are the 2 extra sets of sheets that are supposed to come with my order?![](../images/206/Aspose.Words.84f85360-1bb4-4987-990e-fd6c65ab6365.007.png)
...
#### 9. Click on the Model parameters <img src="https://raw.githubusercontent.com/ibm-build-lab/VAD-VAR-Workshop/main/content/Watsonx/WatsonxAI/images/206/Aspose.Words.84f85360-1bb4-4987-990e-fd6c65ab6365.009.png" width="100%" alt="generate-answer.png" /> icon.
...
#### 14. The flan-t5-xl-3b model returns with Promotion this time. This is again reasonable as this is a complaint about something missing so the problem can be with delivery. But this is not what you want, and Promotion is not a proper category. (Probably note that the answer might vary with this higher temperature. It won't always be "Promotion")
