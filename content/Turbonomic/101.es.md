...
2. Seleccione la opción **Test (Prueba)** del menú desplegable **Purpose (Propósito)** y proporcione una descripción del propósito como `Laboratorio Turbonomic Madrid`.
