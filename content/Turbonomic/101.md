...
1. Use the **Action** button to take actions on on-prem and cloud resources
...
5. Dashboard tab will allow you to create custom dashboards to fit your needs. 

6. **Repors(New)** 

6. **Reports(Legacy)** tab will allow you to generate different reports of your environment and resources. By clicking on **Reports** a new window will open that contains a list of predefined reports under the **General** folder. Explore different reports.
