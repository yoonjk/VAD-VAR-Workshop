...
16. From the **Location** dropdown, select **Cloud Object Storage**. For the **Resource instance ID** field that appears, copy and paste the supplied values for resource ID and API key. 

> These instance values will be supplied to you if you are completing the lab in-person with the VEST team
