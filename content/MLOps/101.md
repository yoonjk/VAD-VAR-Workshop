...
1. Using the **Work with resources** in this IBM Cloud region: dropdown, select the **Dallas** region.
   ...
   - This is **very important** because all of the cloud services that you were instructed to provision in the [Getting started instructions](https://cp4d-outcomes.techzone.ibm.com/data-fabric-lab/getting-started), should be provisioned in the **Dallas** region.
...
This is **very important**. Based on the [Getting started](https://cp4d-outcomes.techzone.ibm.com/data-fabric-lab/getting-started) instructions, you should have your services provisioned in the **Dallas** region.
...
The WML service was created earlier as described on the [Getting started](https://cp4d-outcomes.techzone.ibm.com/data-fabric/getting-started) page.
...
Data science is nothing without data. In this section, you will learn how to make data assets available in a project and how to access the data through a notebook. Data can also be accessed through other available tools, which is covered in the [No-code and low-code solutions](https://cp4d-outcomes.techzone.ibm.com/data-fabric-lab/trusted-ai#No-code_and_low-code_solutions) section of this lab.
