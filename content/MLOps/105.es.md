...
16. En el menú desplegable **Ubicación**, seleccione **Almacenamiento de objetos en la nube**. En el campo **ID de instancia de recurso** que aparece, copie y pegue los valores suministrados para el ID de recurso y la clave de API.

> Estos valores de instancia se le proporcionarán si está completando el laboratorio en persona con el equipo VEST.

![training_data_details](./images/118.png)

1.  Haz clic en el botón **Conectar** situado debajo del campo de **la clave API**. Una vez establecida la conexión con el servicio de almacenamiento de objetos, utilice el menú desplegable **Bucket** para seleccionar **faststartlab-donotdelete-pr.**.. Aparecerá el desplegable **Conjunto de datos**. Utilícelo para seleccionar **modeling_records_2022.csv** y, a continuación, haga clic en **Siguiente**.
