...
2.3 Select the **OpenLDAP Local** user registry

[![](images/nav-to-ldap.png)](images/nav-to-ldap.png)

2.4 Log in with the same credentials your were given for the workshop.
...
5.2 Click on **Projects** in the left navigation and then click on your **_studentnnn_** project in the list
