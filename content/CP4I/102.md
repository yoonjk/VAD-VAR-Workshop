# Lab2: Exercise - Sync Salesforce data using IBM App Connect Enterprise
...
![Architecture diagram](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/architecture.png "")
...
1. [Prerequisites](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#prerequisites "")
2. [Sign up for Salesforce Developer Edition](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-1-sign-up-for-salesforce-developer-edition "")
3. [Create a Salesforce Connected App](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-2-create-a-salesforce-connected-app "")
4. [Setup connectivity to Salesforce in App Connect Designer](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-3-setup-connectivity-to-salesforce-in-app-connect-designer "")
5. [Create the flows in App Connect Designer](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-4-create-the-flows-in-app-connect-designer "")
6. [Create an Integration Server instance and deploy your flows](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-5-create-an-integration-server-instance-and-deploy-your-flows "")
7. [Get the REST endpoint of your App Connect Flow](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-6-get-the-rest-endpoint-of-your-app-connect-flow "")
8. [Test your App Connect Flow with Trader Lite](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-7-test-your-app-connect-flows-with-trader-lite "")
9. [Summary](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#summary "")

> **Note** : You can click on any image in the instructions below to zoom in and see more details. When you do that just click on your browser's back button to return to the previous state.

## Prerequisites[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#prerequisites "Permanent link")

The *TraderLite*  application needs to be up and running on your cluster. If you've completed the API Connect and/or the Salesforce integration labs then you will have the app running already. If you have not completed either of those labs, follow the installation instructions in this [FAQ](https://ibm.github.io/cloudpakforintegration-workshop/faq/#traderlite-application-installation "") before continuing to step 1 below.

## Section 1: Sign up for Salesforce Developer Edition[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-1-sign-up-for-salesforce-developer-edition "Permanent link")
...
## Section 2: Create a Salesforce Connected App[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-2-create-a-salesforce-connected-app "Permanent link")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sflogin.png)](images/sflogin.png "")

2.3 Click on **Setup** .

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfsetup.png)](images/sfsetup.png "")

2.4 In the left navigation area, scroll down to the **Build**  section, expand **Create**  and click on **Apps**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfcreateapp.png)](images/sfcreateapp.png "")

2.5 Scroll down to the **Connected Apps**  section and click on **New**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfconnectedapp.png)](images/sfconnectedapp.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfnewconnectedapp.png)](images/sfnewconnectedapp.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfoauth.png)](images/sfoauth.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/manage-consumer-details.png)](images/manage-consumer-details.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sf-2fa-code.png)](images/sf-2fa-code.png "")

2.11 Copy the **Consumer Key**  and **Consumer Secret**  to a text file.  You will need them later to connect to Salesforce.

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/key-and-secret.png)](images/key-and-secret.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/reset-security-token.png)](images/reset-security-token.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfsectoken.png)](images/sfsectoken.png "")

> **Note:**  Please wait 5-10 minutes before continuing to the next section.

## Section 3: Setup connectivity to Salesforce in App Connect Designer[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-3-setup-connectivity-to-salesforce-in-app-connect-designer "Permanent link")
...
3.1 Go to your Workshop Information page and click on the App Connect Designer component link. (**Note:**  if you no longer have the Workshop Information page available see [these instructions](https://ibm.github.io/cloudpakforintegration-workshop/pre-work/ "")).

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/nav-to-des.png)](images/nav-to-des.png "")

3.2 If prompted to login enter the credentials on the Workshop Information page

3.3 Click the **Catalog**  icon

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/appdesignercatalog.png)](images/appdesignercatalog.png "")

3.4 Expand **Salesforce**  and then click **Connect**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sf-connect.png)](images/sf-connect.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfconnectionform.png)](images/sfconnectionform.png "")
...
## Section 4: Create the flows in App Connect Designer[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-4-create-the-flows-in-app-connect-designer "Permanent link")

4.1 In App Connect Designer, click the **Dashboard**  icon.

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/dashboard.png)](images/dashboard.png "")

4.2 Click **New**  and select **Flows for an API**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/newflow.png)](images/newflow.png "")

4.3 Name the flow `sfpush001` .  Name the model `Client`

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/flowname.png)](images/flowname.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/modelproperties.png)](images/modelproperties.png "")

4.6 Click **Operations**  and then select **Create Client**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/operation.png)](images/operation.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/implementflow1.png)](images/implementflow1.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/automatchfields.png)](images/automatchfields.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/responsedata.png)](images/responsedata.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/testparams.png)](images/testparams.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/edittestparams.png)](images/edittestparams.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/viewdetails.png)](images/viewdetails.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/catalogapis.png)](images/catalogapis.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/add-api-icon.png)](images/add-api-icon.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/connectapi.png)](images/connectapi.png "")

4.21 Accept the default values and click **Connect**  again

4.22 Click on the **Dashboard**  icon

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/dashboard2.png)](images/dashboard2.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/updatedcontact.png)](images/updatedcontact.png "")

4.26 Click the **+**  icon. Expand your **Salesforce Sync for Trader Lit**  API and click on **PUT /salesforce/contacts**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfsyncapi.png)](images/sfsyncapi.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/fieldsmapped.png)](images/fieldsmapped.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/exportevt.png)](images/exportevt.png "")
...
## Section 5: Create an Integration Server instance and deploy your flows[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-5-create-an-integration-server-instance-and-deploy-your-flows "Permanent link")

In this step you'll create an Integration Server instance and deploy your flows to it.

5.1 Go to your Workshop Information page and click on the **App Connect Dashboard**  component link. (**Note:**  if you no longer have the Workshop Information page available see [these instructions](https://ibm.github.io/cloudpakforintegration-workshop/pre-work/ "")).

5.2 If prompted to login enter the credentials on the Workshop Information page.

5.3 Click **Create a server**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/dashboardui.png)](images/dashboardui.png "")

5.4 Select the **Quick start integration**  tile and click **Next**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/qsdesint.png)](images/qsdesint.png "")

5.5 Upload your `sfevent001.bar`  file and click **Next**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/sfeventsbar.png)](images/sfeventsbar.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/accountfile.png)](images/accountfile.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/server-details.png)](images/server-details.png "")

5.9 It will take a while for the server to provision so you can continue deploying the other flow. Click **Create server**

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/create-server2.png)](images/create-server2.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/server-details2.png)](images/server-details2.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/serversdeployed.png)](images/serversdeployed.png "")

## Section 6: Get the REST endpoint of your App Connect Flow[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-6-get-the-rest-endpoint-of-your-app-connect-flow "Permanent link")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/apitile.png)](images/apitile.png "")

6.3 You should see the details of your flow's API

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/apidetails.png)](images/apidetails.png "")

6.4 Copy the **Endpoint**  and save it in a text file.

## Section 7: Test your App Connect Flows with Trader Lite[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#section-7-test-your-app-connect-flows-with-trader-lite "Permanent link")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/select-traderlite-operator.png)](images/select-traderlite-operator.png "")

7.2 Click on the **TraderLite app**  tab

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/traderlite-crd.png)](images/traderlite-crd.png "")

7.3 Click on the 3 periods to the right of the existing TraderLite CRD and select **Edit TraderLite**  from the context menu.

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/select-traderlite-crd.png)](images/select-traderlite-crd.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/enable-sf-integration.png)](images/enable-sf-integration.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/portfolio-restart1.png)](images/portfolio-restart1.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/traderlite-run-tradr.png)](images/traderlite-run-tradr.png "")

7.9 Log in using the username `stock`  and the password `trader`

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/stock-trader-login.png)](images/stock-trader-login.png "")

7.10 Click **Add Client**  and fill in the form. You must use valid email and phone number formats to avoid  errors.

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/new-client.png)](images/new-client.png "")

7.11 Click **Save**

7.12 Click on the **Portfolio ID**  of the new client to see the details of the portfolio

[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/new-portfolio.png)](images/new-portfolio.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/client-details.png)](images/client-details.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/edit-contact.png)](images/edit-contact.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/edit-contact2.png)](images/edit-contact2.png "")
...
[![](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/images/updated-client-details.png)](images/updated-client-details.png "")

## Summary[¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/#summary "Permanent link")
...
from: [Exercise - Sync Salesforce data using IBM App Connect Enterprise¶](https://ibm.github.io/cloudpakforintegration-workshop/exercise-app-connect/)