# Lab3: Exercise - Using IBM MQ and IBM Event Streams for near realtime data replication
...
1. [Uninstall the TraderLite app](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-1-uninstall-the-traderlite-app "")
2. [Create a topic in the Event Streams Management Console](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-2-create-a-topic-in-the-event-streams-management-console "")
3. [Add messaging components to the Trader Lite app](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-3-add-messaging-components-to-the-trader-lite-app "")
4. [Generate some test data with the Trader Lite app](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-4-generate-some-test-data-with-the-traderlite-app "")
5. [Verify your trades have been sent as messages to IBM MQ](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-5-view-messages-in-ibm-mq "")
6. [Start Kafka Replication](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-6-start-kafka-replication "")
7. [Verify transaction data was replicated to the Trade History database](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-7-verify-transaction-data-was-replicated-to-the-trade-history-database "")
8. [Examine the messages sent to your Event Streams topic](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#step-8-examine-the-messages-sent-to-your-event-streams-topic "")
9. [Summary](https://ibm.github.io/cloudpakforintegration-workshop/exercise-event-streaming/#summary "")
