...
2. Within the **CSR 2021** report tile, click the **VIEW** button **(A)**.
    ...
    Find the section **GRI 302: Energy 2016**
...
7. Click **BACK TO DISCLOSURE** at the top to return to the overview page for the CSR 2021 report (C).
   ...
   > <br /><br /> https://ghgprotocol.org/about-us <br />https://ghgprotocol.org/sites/default/files/Scope2_ExecSum_Final.pdf <br />https://www.carbontrust.com/resources/briefing-what-are-scope-3-emissions <br />https://www.nationalgrid.com/stories/energy-explained/what-are-scope-1-2-3-carbon-emissions
...
Continue to [lab 102](/envizi/102).
